...
<body>
    ...
    <div class="contact-page-form-section contact-form-bg"
        style="background-image: url(assets/img/contact-bg-02.png);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="contact-page-wrapper style-03">
                                    <div class="contact-form contact-bg style-01"
                                        style="background-image: url(assets/img/contact-02.png);">
                                        <div class="content desktop-center">
                                            <img src="assets/img/circle-02.png" class="title-shape style-02"
                                                alt="">
