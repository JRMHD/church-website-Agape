                ...
                <div class="col-lg-4">
                    <div class="help-single-item">
                        <div class="content">
                            ...
                            <p>Proin rutrum sem at rutrum ultrirecies. Nunc felis neque, dictum ut porta a, ullamcorper
                                vel ante. Quisque none consequat.</p>
                        </div>
                    </div>
                        ...
                        <div id="accordion">
                            <div class="card">
                                <div class="card-header" id="headingOwo">
                                    <h5 class="mb-0">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            data-target="#collapseOwo" aria-expanded="false"
                                ...
                                <div id="collapseOwo" class="collapse" data-parent="#accordion">
                                    <div class="card-body">
                                        No, ads cannot reference past, current, or proposed referenda Yes, this policy,
                                        enacted end November 2019, political policies. We will iterate on this new
                                        Privacy Policy to include. People can report content in the Twitter timeline or
                                        through this Help Cen.
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h5 class="mb-0">
                                        <a class="collapsed show" role="button" data-toggle="collapse"
                                ...
                                <div class="card-header" id="headingThree">
                                    <h5 class="mb-0">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            <i class="fas fa-star"></i>
                                            Which ones does this new policy apply to?
                                        </a>
                                    </h5>
                                </div>
