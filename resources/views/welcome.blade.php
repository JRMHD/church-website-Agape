                ...
                <div class="col-lg-12">
                    <div class="header-inner">
                        ...
                        <div class="subtitle style-01">
                            <span style="font-weight: bold; color: black;">AGAPE TEMPLE GLOBAL MINISTRY</span>
                        </div>
                        <h1 class="title style-01">Transforming Lives Through the Power of God's Love</h1>
                        <p class="style-01">Join Founding Pastor Rev. Helene H. Oord and Apostle Geoffrey J. Mboga as we
                            spread the Gospel of Jesus Christ from the Netherlands to Nairobi, Kenya — igniting faith,
                            healing hearts, and equipping believers worldwide.</p>
                        <div class="btn-wrapper desktop-center">
                            <a href="/contact" class="boxed-btn btn-sanatory style-01 text-uppercase">Join us today <i
                                    class="fas fa-chevron-right"></i></a>
                            <a class="video-play style-04 mfp-iframe"
                                href="https://www.youtube.com/@agapetempleglobalministryafric">
                                <i class="fas fa-play"></i> <span>WATCH MESSAGE</span>
                            </a>
                        </div>
                    </div>
    ...
    <div class="meet-member-section">
        ...
        <div class="container">
            <div class="meet-member-wrapper">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="meet-member-img" style="background-image: url(/assets/img/pastorhelene.jpg.jpg);">
